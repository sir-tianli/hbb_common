...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.insother.com"];
pub const RS_PUB_KEY: &str = "AhMRPOjmQruhK6N7tC+m5Q8WQZY088kfwk0BzD0o2xs=";
...
pub mod keys {
    ...
    pub const OPTION_API_SERVER: &str = "http://rustdesk.insother.com:21114";
